...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DcALKa0sVD', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'});
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'session.save_path' => '/var/lib/php/session/prod',
